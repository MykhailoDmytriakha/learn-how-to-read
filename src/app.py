...
SAMPLE_PHRASES = [
    ...
    "Долго сидел я с удочкой на берегу. Не клюют у меня пескари. А дед под кустиком сидит и уже ведерко наловил. Сел и я в тени. Сразу пескари клевать стали.", 
    ...
    "Данил бежит быстро!",  # Простые глаголы действия
    "Мяч летит вверх!",
    "Играем в догонялки!",
    "Качели летят высоко.",
    ...
    "Солнце светит ярко.",
    "Мы прыгаем на кровати.",  # Бытовая ситуация
    "Ведро с песком тяжёлое.",
    "Папа катит машинку.",
    "Данил строит высокую башню из кубиков.",  # Описание процесса
    "Мы запускаем воздушного змея в парке.",
    "Горячий шарик лопнул с треском!",
    "На роликах качусь быстро-быстро!",
    "Весёлые брызги в бассейне.",  # Водные игры
    ...
    "Данил объезжает лужи на велосипеде.",  # Сложные глаголы
