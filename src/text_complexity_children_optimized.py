...
def get_children_bigram_frequency() -> Dict[str, float]:
    ...
    return {
        ...
        'то': 3.2, 'на': 2.8, 'ст': 2.1, 'не': 2.0, 'ко': 1.8,
        'ро': 1.6, 'ла': 1.5, 'во': 1.4, 'ма': 1.3, 'ле': 1.2,
        'ра': 1.1, 'та': 1.0, 'са': 0.9, 'по': 0.9, 'ли': 0.8,
        
        # Сложные сочетания для детей
        'нн': 0.3, 'тс': 0.2, 'ск': 0.4, 'сл': 0.3, 'зн': 0.2,
        'дн': 0.3, 'рт': 0.2, 'нт': 0.3, 'кт': 0.2, 'пт': 0.1,
        
        # Очень сложные сочетания
        'щн': 0.05, 'жн': 0.03, 'шн': 0.04, 'зч': 0.02, 'тч': 0.03,
    }
...
def calculate_children_text_complexity_optimized(
    text: str, 
    age: int = 8, 
...
def get_children_complexity_breakdown(
    text: str, 
    age: int = 8, 
    include_cognitive_load: bool = True
) -> Dict[str, float]:
    ...
    """
    linguistic_complexity = calculate_children_text_complexity_optimized(
        text, age=age, include_cognitive_load=False
    )
...
def compare_algorithms_children_vs_original(
    text: str, 
    age: int = 8, 
    include_cognitive_load: bool = True
) -> Dict[str, float]:
    ...
    original_score = calculate_text_complexity_improved(
        text, age=age, include_cognitive_load=include_cognitive_load
    )
    
    # Новый детский алгоритм
    children_score = calculate_children_text_complexity_optimized(
        text, age=age, include_cognitive_load=include_cognitive_load
    )
